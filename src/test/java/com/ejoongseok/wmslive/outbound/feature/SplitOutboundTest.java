...
class SplitOutboundTest extends ApiTest {
    ...
    void splitOutbound() {
        ...
        assertThat(outboundRepository.getBy(outboundNo).getOutboundProducts().toList()).hasSize(2);
    ...
    private void assertSplit(final Long outboundNo) {
        ...
        assertThat(refresh.getOutboundProducts().toList().get(0).getProductNo()).isEqualTo(2);
